...
<hr>
 <div class="tab-pane fade active in" id="detail">
  ...
  action="/api/items/<?=$item["uuid"]?>" 
  >
    <div class="form-group">
      </div>
      <div class="form-group">
        <label for="uuid">Uuid</label>
        <input type="text" class="form-control" disabled id="uuid" name="uuid" value="<?= $item["uuid"]; ?>">
      </div>
      ...
      <div class="form-group">
        ...
        <input type="number" name="price" class="form-control" id="price" value = "<?= $item["price"]; ?>" autocomplete="off"> 
      </div>
