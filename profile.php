  ...
  >
    ...
    <div class="form-group">
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control" disabled id="uuid" name="uuid" value="<?= $user["uuid"]; ?>">
      </div>

      <div class="form-group">
        <label for="right">Right</label>
        <input type="text" name="right" class="form-control" disabled id="right" value="<?= $user["right"]; ?>" >
      </div>
      ...
      <?php if($user['right'] == "admin"){?>
      <a href="/users" class="btn btn-primary">allUsersView</a>
      <a href="/addItem" class="btn btn-primary">addItem</a>
      <a href="/allItemEdit" class="btn btn-primary">itemEdit</a>
      <?php }?>
